...
public class RSAdminUserController {
    ...
    public Result list(@RequestParam Map<String, Object> params) {
        ...
        return ResultGenerator.genSuccessResult(RSUserService.getRSUsersPage(pageUtil));
    }
    ...
    public Result delete(@RequestBody Integer[] ids, @PathVariable int lockStatus) {
        ...
        if (RSUserService.lockUsers(ids, lockStatus)) {

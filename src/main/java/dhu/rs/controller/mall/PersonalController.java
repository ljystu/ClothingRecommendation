...
public class PersonalController {
    ...
    public Result login(@RequestParam("loginName") String loginName,
        ...
        //todo 清verifyCode
        String loginResult = RSUserService.login(loginName, MD5Util.MD5Encode(password, "UTF-8"), httpSession);
        //登录成功

        if(ServiceResultEnum.NEED_INFORMATION.getResult().equals(loginResult)){
            return ResultGenerator.genSuccessResult("需要进行调查");
        }
    ...
    public Result register(@RequestParam("loginName") String loginName,
        ...
        //todo 清verifyCode
        String registerResult = RSUserService.register(loginName, password);
        //注册成功
    ...
    public Result updateInfo(@RequestBody MallUser mallUser, HttpSession httpSession) {
        RSUserVO mallUserTemp = RSUserService.updateUserInfo(mallUser,httpSession);
